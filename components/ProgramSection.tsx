...
const ProgramSection = forwardRef<HTMLElement>((props, ref) => {
  ...
  const modules = [
    ...
    { title: "Биомеханика", icon: Brain, number: "02" },
    { title: "Питание", icon: Stethoscope, number: "03" },
    { title: "Техника упражнений", icon: Dumbbell, number: "04" },
    { title: "Работа с клиентом", icon: Users, number: "05" },
    { title: "Составление программ", icon: ClipboardList, number: "06" },
    { title: "Кинезиотерапия", icon: ShieldPlus, number: "07", desc: "бонус в офлайн Астане" },
    { title: "Первая медицинская помощь", icon: GraduationCap, number: "08", desc: "бонус в офлайн Астане" },
    { title: "Практика", icon: TrendingUp, number: "09" },
    { title: "Экзамен", icon: Award, number: "10" },
  ];
  ...
  return (
    <section ref={(node) => {
    ...
    }} id="programs" className="relative section-padding bg-gradient-to-b from-[#0a0a0a] via-[#0a0a0a] to-[#0a0a0a]">
      {/* Background image */}
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p ref={subtitleRef} className="text-center text-lg text-white/40 mb-16 font-gilroy max-w-2xl mx-auto">
          10 модулей для реальной работы тренером
        </p>
        ...
        <div ref={ctaRef} className="text-center mt-14">
          <a 
            ...
            className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-2xl text-base font-bold hover:shadow-[0_0_40px_rgba(37,211,102,0.2)] transition-all duration-300 font-gilroy"
          >
            ...
            Смотреть полную программу в WhatsApp
          </a>
        </div>
      </div>
    </section>
